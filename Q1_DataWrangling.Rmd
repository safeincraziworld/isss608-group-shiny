...
```{r save rds}
saveRDS(all, 'group-shiny/data/Q1/all.rds')
saveRDS(all_wday, 'group-shiny/data/Q1/all_wday.rds')
saveRDS(restaurants, 'group-shiny/data/Q1/restaurants.rds')
saveRDS(pubs, 'group-shiny/data/Q1/pubs.rds')
```
...
```{r save all_monthly}
saveRDS(all_monthly, 'group-shiny/data/Q1/all_monthly.rds')
```
